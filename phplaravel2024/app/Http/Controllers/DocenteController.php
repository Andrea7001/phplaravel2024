...
class DocenteController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('docentes.index')->with('success', 'Docentes creado correctamente');
    }
    ...
    public function destroy($id)
    {
        ...
        $docente->delete();
        return redirect()->route('docentes.index')->with('success', 'Docentes eliminado correctamente.');
    }
